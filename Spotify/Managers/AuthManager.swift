...
final class AuthManager {
    ...
    struct Constants {
        static let clientID = "3cf66ba7f88f4c43ba6f6a7a3fb49241"
        static let clientSecret = "9c387e24a24641af8e8e54c79b1ce665"
    ...
    public func withValidToken(completion: @escaping (String) -> Void) {
        guard !refreshingToken else {
            // Append the completion to be executed once refreshing has completed
    ...
    public func refreshAccessTokenIfNeeded(completion: ((Bool) -> Void)?) {
        ...
        guard shouldRefreshToken else {
            completion?(true) // meaning token still valid
            return
        }
    ...
    private func cacheAccessToken(result: AuthResponse) {
